...
export const onboardingComponents: ComponentEntry[] = [
  ...
  },
  {
    ...
    mockData: () => ({
      ...
      onSubmit: (data: { apiKey: string; baseUrl?: string; customModel?: string; customModels?: string[] }) => console.log('[Playground] Submitted:', data),
  ...
  },
  {
    ...
    mockData: () => ({
      ...
      onSubmitCredential: (data: { apiKey: string; baseUrl?: string; customModel?: string; customModels?: string[] }) => console.log('[Playground] Submitted:', data),
      onStartOAuth: noopHandler,
      onFinish: noopHandler,
